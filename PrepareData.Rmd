...
```{r}
QM.data=read.csv("QM_data.csv", stringsAsFactors = F)
QM.data$ID=QM.data$ï..ID
QM.data$ï..ID=NULL
...
```{r}
subToSuperCat=read.csv("sub to super categories.csv", header = T, fill = T, strip.white = T, stringsAsFactors=F, check.names=F)
